...
class ProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_produk->save();
        $new_produk->categories()->attach($request->get('categories'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $produk->categories()->sync($request->get('categories'));
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('produks.index')->with('status', 'produk moved to trash');
    }
...
$produk->categories()->detach();
$produk->forceDelete();
return redirect()->route('produks.trash')->with('status', 'produk
permanently deleted!');
}
}
}
