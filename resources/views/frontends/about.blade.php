...
<!-- Mirrored from demo.devitems.com/uniqlo/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:40:09 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon" href="{{ assets('/assets/frontend/uniqlo/apple-touch-icon.png')}}">
                ...
                <div class="shopping__cart__inner">
                    ...
                    <div class="shp__cart__wrap">
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ assets('/assets/frontend/uniqlo/images/product/sm-img/2.jpg')}}" alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
                    ...
                    <div class="team__wrap clearfix mt--60">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                            <div class="team foo">
                                <div class="team__thumb">
                                    <a href="#">
                                        <img src="{{ assets('/assets/frontend/uniqlo/images/team/1.jpg')}}" alt="team images">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 xmt-30">
                            <div class="team foo">
                                <div class="team__thumb">
                                    <a href="#">
                                        <img src="{{ assets('/assets/frontend/uniqlo/images/team/2.jpg')}}" alt="team images">
                                    </a>
                                </div>
                                <div class="team__bg__color"></div>
                                <div class="team__hover__info">
                        ...
                        <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-30">
                            <div class="team foo">
                                <div class="team__thumb">
                                    <a href="#">
                                        <img src="{{ assets('/assets/frontend/uniqlo/images/team/4.jpg')}}" alt="team images">
                                    </a>
                                </div>
                                <div class="team__bg__color"></div>
                                <div class="team__hover__info">
                        ...
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{ assets('/assets/frontend/uniqlo/images/test/client/1.png')}}" alt="testimonial images">
                                </div>
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{ assets('/assets/frontend/uniqlo/images/test/client/2.png')}}" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{ assets('/assets/frontend/uniqlo/images/test/client/3.png')}}" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="brand__list">
                            <li><a href="#">
                                <img src="{{ assets('/assets/frontend/uniqlo/images/brand/1.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{ assets('/assets/frontend/uniqlo/images/brand/2.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{ assets('/assets/frontend/uniqlo/images/brand/3.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{ assets('/assets/frontend/uniqlo/images/brand/4.png')}}" alt="brand images">
                            </a></li>
                            <li class="hidden-sm"><a href="#">
                                <img src="{{ assets('/assets/frontend/uniqlo/images/brand/5.png')}}" alt="brand images">
                            </a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer__container clearfix">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6">
                            <div class="ft__widget">
                                <div class="ft__logo">
                                    <a href="index.html">
                                        <img src="{{ assets('/assets/frontend/uniqlo/images/logo/uniqlo.png')}}" alt="footer logo">
                                    </a>
                                </div>
...
<!-- Mirrored from demo.devitems.com/uniqlo/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:40:40 GMT -->
</html>