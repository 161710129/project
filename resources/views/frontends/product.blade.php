                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="{{ asset ('assets/frontend/img/product-img/product-9.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-9.jpg') }}" alt="First slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="{{ asset ('assets/frontend/img/product-img/product-2.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-2.jpg') }}" alt="Second slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="{{ asset ('assets/frontend/img/product-img/product-3.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-3.jpg') }}" alt="Third slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="{{ asset ('assets/frontend/img/product-img/product-4.jpg') }}">
